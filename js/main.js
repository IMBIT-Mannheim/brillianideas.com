...
var digitalLearning = function (file) {
  ...
  $display = {
    yoffset:
      (!(
        $("#animation_yaxis_top").height() >
        $("#animation_yaxis_bottom").height()
      )
        ? $("#animation_yaxis_bottom").height()
        : $("#animation_yaxis_top").height()) *
        2 /*+ dotsspace */ +
