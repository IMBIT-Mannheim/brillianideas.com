    ...
    if (numberOfQuizLists > 0) {
      for (var z = 0; z < numberOfQuizLists; z++) {
        ...
        for (i = 0; i < data.quizGames[z].quizlist.length; i++) {
          ...
          for (
            j = 0;
            j < data.quizGames[z].quizlist[i].optionFalse.length;
            j++
          ) {
            questionBank[i][j + 2] =
              data.quizGames[z].quizlist[i].optionFalse[j];
          }
        }
      } //for(var z=0;z<numberOfQuizLists;z++) {
    }
    ...
    if (numberOfDragAndDropGames > 0) {
      ...
      for (var k = 0; k < numberOfDragAndDropGames; k++) {
        ...
        for (var i = 0; i < data.DragDropGames[k].DragAndDropList.length; i++) {
          ...
          tempDragAndDropBank[i][0] =
            data.DragDropGames[k].DragAndDropList[i].id;
          ...
          if (data.DragDropGames[k].DragAndDropList[i].id == "d0") {
            dragAndDropGameTitle =
              data.DragDropGames[k].DragAndDropList[i].title;
            dragAndDropGameDescription =
              data.DragDropGames[k].DragAndDropList[i].description;
            numberOfTargets =
              data.DragDropGames[k].DragAndDropList[i].targetNumber;
...
function displayDragAndDropGame(numberOfCurrentDragDropGame) {
  ...
  if (!$(".background").find(".BobTentacleRight").length > 0) {
    $(".background").append(
      '<img alt="Tentakel" src="img/miniGames/tentakel_right_MiniGames.png" id ="BobTentacleRightId" class="BobTentacleRight" style="object-fit: contain">'
    );
  }
  ...
  if ($("#source").children().length == 0) {
    ...
    for (var i = 0; i < currentNumberOfDragAndDropElements; i++) {
      if (numberOfTargetsOfCurrentGame == 2) {
        ...
        if ($(currentid).attr("target") == "target1") {
          if (
            $(document.getElementById("d" + i)).parents("#target1").length == 1
          ) {
          ...
          if (
            $(document.getElementById("d" + i)).parents("#target2").length == 1
          ) {
            document.getElementById("d" + i).style.backgroundColor =
              "rgb(153,27,51)";
          } else {
      ...
      if (numberOfTargetsOfCurrentGame == 3) {
        ...
        if ($(currentid).attr("target") == "target1") {
          ...
          if (
            $(document.getElementById("d" + i)).parents("#target3").length == 1
          ) {
            document.getElementById("d" + i).style.backgroundColor =
              "rgb(153,27,51)";
          } else {
      ...
      if (numberOfTargetsOfCurrentGame == 4) {
        ...
        if ($(currentid).attr("target") == "target1") {
          ...
          if (
            $(document.getElementById("d" + i)).parents("#target4").length == 1
          ) {
            document.getElementById("d" + i).style.backgroundColor =
              "rgb(153,27,51)";
          } else {
    ...
    if (wrongElement == 0) {
      ...
      if ($("#goToNextQuiz").length > 0) {
        ...
        $("#button").append('<div id="goToNextQuiz" class="next">Weiter</div>');
      }
...
function displayQuizListQuestion(numberOfDragAndDropGamesPlayed) {
  ...
  for (i = 1; i < questionBank[questionNumber].length; i++) {
    ...
    contentArray[i - 1] =
      "<div id=" + i + ' class="option" tabindex="1">' + q[i - 1] + "</div>";
    optionsCounter++;
  }
  if (optionsCounter > 2) {
    ...
    if (!$("#navContent").find(".bob").length > 0) {
      $("#navContent").append(
        '<img alt="Krakenkopf" src="img/miniGames/brillainIDEAS_UX_20170202_Oktopus-Kopf3.2_F.png" id ="bobId"class="bob" style="object-fit: contain">'
      );
    }
  ...
  $(".option").click(function () {
    ...
    if (questionLock == false) {
      ...
      if (this.id == 1) {
        ...
        if (randomNumber == 1) {
          changeBobImage(
            "img/miniGames/brillainIDEAS_UX_20170202_Oktopus-Kopf3_F.png"
          );
        } else if (randomNumber == 2) {
          changeBobImage(
            "img/miniGames/brillainIDEAS_UX_20170202_Oktopus-Kopf3.1_F.png"
          );
        }
      ...
      if (this.id != 1) {
        ...
        if (randomNumber == 1) {
          changeBobImage(
            "img/miniGames/brillainIDEAS_UX_20170202_Oktopus-Kopf3.4_F.png"
          );
        } else if (randomNumber == 2) {
          changeBobImage(
            "img/miniGames/brillainIDEAS_UX_20170202_Oktopus-Kopf3.3_F.png"
          );
        }
      ...
      $(".next").click(function () {
        ...
        changeBobImage(
          "img/miniGames/brillainIDEAS_UX_20170202_Oktopus-Kopf3.2_F.png"
        );
        changeQuestion(0);
      });
    }
